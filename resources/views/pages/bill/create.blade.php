			...
			<div class="card card-warning">
				<div class="card-body">
					<form method="POST" action="{{ route('bill.store') }}">
						...
						{{-- workOrder_id --}}
						<div class="form-group">
							<label for="workOrder_id">
								Work Order No
							</label>

							<input type="text" class="form-control{{ $errors->has('workOrder_id') ? ' is-invalid' : '' }}" name="workOrder_id" id="workOrder_id" value="{{ old('workOrder_id', optional($bill)->workOrder_id) }}">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control{{ $errors->has('challan_no') ? ' is-invalid' : '' }}" name="challan_no" id="challan_no" value="{{ old('challan_no', optional($bill)->challan_no) }}">
						...
						<div class="form-group">
							...
							<select name="customer_id" class="form-control{{ $errors->has('customer_id') ? ' is-invalid' : '' }}" id="customer_id">
								...
								<option value="{{ $customer->id }}" {{old('customer_id', optional($bill)->customer_id) == $customer->id ? 'selected':''}}>{{ $customer->name }}</option>
								@endforeach
							</select>
						...
						{{-- <div class="form-group">
							...
							<input class="form-control{{ $errors->has('payment') ? ' is-invalid' : '' }}" type="number" name="payment" step="any" min="0" value="{{ old('payment') }}">
