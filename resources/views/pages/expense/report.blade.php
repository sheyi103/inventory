...
<div class="button-inline">
	{{-- Report --}}
	<form  method="GET" action="{{url('expense/report')}}" class="form-inline report-form">
		@csrf
	...
	<form id="particularexpense" method="GET" action="{{ url('pdf-expense-report') }}" class="form-inline">
		@csrf
		<input type="hidden" name="start_date" id="start_date" class="form-control" required="required" value="{{ $start_date }}">
		<input type="hidden" name="end_date" id="end_date" class="form-control" required="required" value="{{ $end_date }}">
	...
	<form id="particularexpense" method="GET" action="{{ url('excel-expense-report') }}" class="form-inline">
		@csrf
		<input type="hidden" name="start_date" id="start_date" class="form-control" required="required" value="{{ $start_date }}">
		<input type="hidden" name="end_date" id="end_date" class="form-control" required="required" value="{{ $end_date }}">
